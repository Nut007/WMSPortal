...
namespace WMSPortal.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ICacheProvider cacheProvider, IUserRepository userRepository,IUserLogRepository userLogRepository)
        {
        ...
        public async Task<ActionResult> Login(AccountLoginModel viewModel)
        {
            ...
            var user = _userRepository.FindByUserAndPassword(viewModel.UserName, viewModel.Password);
            ...
            if (user != null)
            {
                Role roleConnection = user.Roles.Where(s => s.Id == Convert.ToInt16(viewModel.ConnectionId)).SingleOrDefault();
                user.CurrentRoleConnection = roleConnection;
                user.RoleId = Convert.ToInt16(viewModel.ConnectionId);

                UserLog userLog = new UserLog();
                userLog.LoginName = user.UserName;
                userLog.EventDate = DateTime.Now;
                userLog.EventType = EventLog.Login.ToString();
                ...
                //    viewModel.ReturnUrl = "~/Home/Index";
                //else
                //    viewModel.ReturnUrl = "~/Orders/OrdersList";
        ...
        public ActionResult Logout()
        {
            ...
            if (System.Web.HttpContext.Current.Session["userRoles"] == null)
                ...
                userName = ((User)System.Web.HttpContext.Current.Session["userRoles"]).UserName;
            ...
            {  
                ...
                userLog.EventDate = DateTime.Now;
                userLog.EventType = EventLog.Logout.ToString();
                _userLogRepository.CreateUserLog(userLog);
            }
        ...
        private ActionResult RedirectToLocal(string returnUrl = "")
        {
            ...
            if (System.Web.HttpContext.Current.Session["userRoles"] == null)
                ...
                connectionId = ((User)System.Web.HttpContext.Current.Session["userRoles"]).CurrentRoleConnection.Id;

            // If we cannot verify if the url is local to our host we redirect to a default location
            return RedirectToAction("index", "home", new { connectionId = connectionId });
        }
